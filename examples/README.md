...
save that it can also fetch and manage the version of `geth` from the `arkiv-op-geth` github releases.
...
1. clone the [arkiv-op-geth repository](https://github.com/Arkiv-Network/arkiv-op-geth), or [download a source release](https://github.com/Arkiv-Network/arkiv-op-geth/releases)
2. [run the docker container](https://github.com/Arkiv-Network/arkiv-op-geth/blob/main/RUN_LOCALLY.md) to spin up a local node
3. use the command line application to [create and add funds to an account](https://github.com/Arkiv-Network/arkiv-op-geth/blob/main/cmd/golembase/README.md)
